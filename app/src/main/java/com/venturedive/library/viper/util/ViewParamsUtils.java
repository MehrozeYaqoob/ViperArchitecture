package com.venturedive.library.viper.util;
...
public class ViewParamsUtils {
     ...
     * @param marginTop the margin top in pixels
     */
     ...
     */
    private static void setViewMargin(View v, int left, int top, int right, int bottom) {
